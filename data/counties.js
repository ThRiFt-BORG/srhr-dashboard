...
window.COUNTIES = [
  {
    ...
    advocacy_materials: [
      ...
      { policy:"Homa Bay County Sexual & Gender-Based Violence Control and Management Bill (2024)", theme:"Gender-Based Violence (SGBV)", stage:"Legislative Action", materials:{ decision_maker:{label:"Policy Brief",urls:[]}, community:{label:"Community Flyer",urls:[]}, media:{label:"Social Media Cards",urls:[]} } },
      { policy:"Homa Bay Sexual & Gender-Based Violence Policy (2023)", theme:"Gender-Based Violence (SGBV)", stage:"Implementation", materials:{ decision_maker:{label:"Policy Brief",urls:[]}, community:{label:"Community Flyer",urls:[]}, media:{label:"Social Media Cards",urls:[]} } },
      { policy:"National School Re-entry Guidelines (2020)", theme:"School Re-entry for Adolescent Mothers", stage:"County Domestication & Implementation", materials:{ decision_maker:{label:"County Brief",urls:[]}, community:{label:"Poster • Flyer",urls:[]}, media:{label:"Social Media Cards",urls:[]} } },
      ...
      { policy:"Homa Bay County HIV & AIDS Strategic Plan (2020–2025)", theme:"Contraceptive Access & HIV Integration", stage:"Implementation", materials:{ decision_maker:{label:"County Brief",urls:[]}, community:{label:"Community Flyer",urls:[]}, media:{label:"Social Media Cards",urls:[]} } },
      { policy:"Homa Bay County Health Services Act (2020)", theme:"Post-Abortion Care (PAC)", stage:"Implementation", materials:{ decision_maker:{label:"Policy Brief",urls:[]}, community:{label:"Community Flyer",urls:[]}, media:{label:"Social Media Cards",urls:[]} } },
      { policy:"Homa Bay County Health Services Act (2020)", theme:"Disability Inclusion in SRHR Services", stage:"Implementation", materials:{ decision_maker:{label:"Policy Brief",urls:[]}, community:{label:"Community Flyer",urls:[]}, media:{label:"Social Media Cards",urls:[]} } },
      { policy:"County Integrated Development Plan (CIDP)", theme:"SRHR Mainstreaming in County Planning", stage:"Implementation", materials:{ decision_maker:{label:"CIDP Advocacy Brief",urls:[]}, community:{label:"Community Flyer",urls:[]}, media:{label:"Social Media Cards",urls:[]} } },
