...
window.COUNTIES = [
  ...
  },
  {
    ...
    policies: [
      ...
      { id:"kf-p08", name:"Kilifi County Adolescent and Young People (AYP) Health Strategy (2025–2030)", year:2025, status:"Under Review", impl_pct:0, actors:["Ministry of Health","CHMT","Gender Technical Working Group","CSOs — Health Thematic Group"], gap:"Strategy pending adoption and operationalization", advocacy:"Support CSOs to advocate and lobby for adoption and operationalization of the Strategy", doc_url:"" },
      ...
      { id:"kf-p10", name:"Persons with Disabilities Act (Kilifi county-level)", year:2003, status:"Limited Implementation", impl_pct:17, actors:["County Government of Kilifi"], gap:"Limited physical accessibility; inadequate disability-inclusive SRHR services", advocacy:"Advocate for accessibility improvements; push for disability-inclusive SRHR training", doc_url:"" }
    ],
    advocacy_materials: [
